...
```sh
  cd my-folder
  git clone https://github.com/supreeti/Math-magicians.git
```
### Install
...
Feel free to check the [issues page](https://github.com/supreeti/Math-magicians/issues/new).
...
This project is [MIT](https://github.com/supreeti/Math-magicians/blob/main/LICENSE) licensed.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
